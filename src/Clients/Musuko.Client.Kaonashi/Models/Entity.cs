    ...
    public class Entity : EntityBase
    {
        ...
        public string Type
        {
            ...
            set
            {
                ...
                if (!(value == "PERSON" || value == "LOCATION" || value == "CONTRAT" || value == "ORG" || value == "DATE" || value == "TIME" || value == "MONEY" || value == "QUANTITY" || value == "PRODUCT" || value == "EVENT" || value =="APPLICATION" || value == "AGENT"))
                {
                    _Type = "OTHER_ENTITY";
                }
                else
